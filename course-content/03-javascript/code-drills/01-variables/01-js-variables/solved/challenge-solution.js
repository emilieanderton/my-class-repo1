...
let knownFor = "the first computer programmer";
...
let statementOne = subject + ": " + fullName + "is a " + nationality + " " + profession + "born in " + birthYear + ".";
...
// much like you did for the console logs and `fullName`
let statementTwo = "She is commonly referred to as " + knownFor;
...
// much like you did for the console logs and `fullName`
let statementThree = "In " + yearOfPublish + " she publised the first Algorithm, the " + firstAlgorithm + ", at the age of " + ageAtYearOfPublish;
...
// much like you did for the console logs and `fullName`
let statementFour = "She was a " + nationality + "Citizen who lived in " + cityLocation + ", " + countryLocation + "until her passing at the age of " + ageAtPassing;
