...
4. [Learning Assistant Support](#learning-assistant)          
...
Class videos will be avaiable on BCS once processed by zoom
...
24 Tutoring Sessions will be made available to you to use as you see fit.
We suggest using them 2 x week
...
**Sessions should be 50 minutes in length. Twice a week via a video hangout.**
...
#### Evening Office Hours (start of class)

1. TA, James,  will reside a breakout room intended for Review - `#evening-review`. 
...
4. TA will reside a breakout room intended for 1:1 Support - reserve a 15 minute session to get unstuck.  - see `#_coding-bootcamp` morning messages for RESVP link - Each student can reserve 15 minutes. 
5. When it is your reserved time you will moved to join - see `#_coding-bootcamp` for link - their breakout room. 
6. And when your time is up you will be moved out of your team breakout room. 



#### Night Office Hours

1. TA, Maria, will reside a breakout room intended for Review - `#night-review`. 
2. The main room is a general Study area.
3. TA will reside a breakout room intended for 1:1 Support - reserve a 15 minute session to get unstuck.  - see `#_coding-bootcamp` morning messages for RESVP link - Each student can reserve 15 minutes. 
4. When it is your reserved time you will moved to join - see `#_coding-bootcamp` for link - their breakout room. 
5. And when your time is up you will be moved out of your team breakout room. 
6. Instructor will be meeting with be scheduling 1:1 with students as the course progresses. 


*1:1 Office Hours are intended to get you unstuck*  
...
1. Once a you arrive to class you will be moved into your Team Breakout room during Project Time

<hr>

####  Learning Assistant

AskBCS is an interactive messaging system created to match you with a Learning Assistant who can answer your curriculum-based, technical questions.                      
Learning Assistant Support is offered 24 hours a day, 7 days a week! 

#### What to use AskBCS for
* Module or In-Class Activity Questions
* Homework Questions
* Technical Questions

#### What NOT to use AskBCS for
